<template>
  <div>
    ...
    <TarModal centered :close="t('actions.close')" fade scrollable ref="modal" :title="t('trainers.create')">
...
import type { CreateOrReplaceTrainerPayload, Trainer } from "@/types/trainers";
