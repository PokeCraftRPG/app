<template>
  <main class="container page">
    ...
    <SpeciesProperties class="border-top border-secondary-subtle pt-4" @created="onCreated" @error="handleError" />
  </main>
</template>
...
const title = computed<string>(() => t("species.create"));

function onCreated(species: Species): void {
  events.push("created");
