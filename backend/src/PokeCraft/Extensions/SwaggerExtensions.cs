...
internal static class SwaggerExtensions
{
  public static IServiceCollection AddSwagger(this IServiceCollection services)
  {
    services.AddSwaggerGen(config =>
    {
      ...
      config.SwaggerDoc(name: $"v{Api.Version.Major}", new OpenApiInfo
      {
        ...
        Description = "PokéCraft is an adaption of the SkillCraft Tabletop Role-Playing Game faithful to original Pokémon games.\r\n",
        License = new OpenApiLicense
        {
          Name = "Use under MIT",
          Url = new Uri("https://github.com/PokeCraftRPG/app/blob/main/LICENSE", UriKind.Absolute)
        },
        Title = Api.Title,
  ...
  public static void MapSwagger(this IApplicationBuilder builder)
  {
    builder.UseSwagger();
